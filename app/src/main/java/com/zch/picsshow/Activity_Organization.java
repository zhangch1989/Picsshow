...
public class Activity_Organization extends BaseActivity {
    ...
    private void initData(){
        img_data.clear();
        img_data.add(new ImageInfo("organization/1.png"));
        img_data.add(new ImageInfo("organization/2.png"));
        img_data.add(new ImageInfo("organization/3.png"));
        img_data.add(new ImageInfo("organization/4.png"));
    }
